...
- 🪂 **Parties 2, 3 & 4** : `git merge --no-edit origin/part-N-prod` (cf. README) récupère le code de prod — filez directement aux tests
...
🪂 <strong>Raccourci dispo</strong> — <code>git merge --no-edit origin/part-2-prod</code> (cf. README) recopie le code de prod tel quel
</div>
...
<div class="cherry-pick">
🪂 <strong>Raccourci dispo</strong> — <code>git merge --no-edit origin/part-3-prod</code> (cf. README) recopie le code de prod tel quel
</div>
...
<div class="cherry-pick">
🪂 <strong>Raccourci dispo</strong> — <code>git merge --no-edit origin/part-4-prod</code> (cf. README) recopie le code de prod tel quel
</div>
