...
export class OrderBuilder {
  ...
  static confirmed(): OrderBuilder {
    return new OrderBuilder().withStatus(OrderStatus.Confirmed);
  }
  ...
  withTransaction(transactionId: string): OrderBuilder {
    this.transactionId = transactionId;
    return this;
  }

  withoutTransaction(): OrderBuilder {
    this.transactionId = null;
    return this;
  }

  withTracking(trackingNumber: string): OrderBuilder {
    this.trackingNumber = trackingNumber;
    return this;
  }

  withoutTracking(): OrderBuilder {
