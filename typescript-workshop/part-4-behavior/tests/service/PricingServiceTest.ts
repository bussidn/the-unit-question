...
describe('PricingService', () => {
  ...
  it('p4_calculateTotal_withNoDiscount_appliesShippingWhenSubtotalBelowThreshold', () => {
  ...
  it('p4_calculateTotal_withNoDiscount_noShippingWhenSubtotalAtOrAboveThreshold', () => {
  ...
  it('p4_calculateTotal_withDiscount_thresholdAppliedOnDiscountedSubtotal', () => {
  ...
  it('p4_calculateTotal_withDiscount_noShippingWhenDiscountedSubtotalAboveThreshold', () => {
  ...
  it('p4_calculateTotal_withONCE50_halvesPriceAndAppliesShipping', () => {
    const items = [new OrderItem('PROD-001', 2, 55.0)];
