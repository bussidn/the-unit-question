...
class PricingServiceTest {
    ...
    @Test
    void p1_calculateTotal_withNoDiscount_appliesShippingWhenSubtotalBelowThreshold() {
    ...
    @Test
    void p1_calculateTotal_withNoDiscount_noShippingWhenSubtotalAtOrAboveThreshold() {
    ...
    @Test
    void p1_calculateTotal_withDiscount_thresholdAppliedOnDiscountedSubtotal() {
    ...
    @Test
    void p1_calculateTotal_withDiscount_noShippingWhenDiscountedSubtotalAboveThreshold() {
    ...
    @Test
    void p1_calculateTotal_withONCE50_halvesPriceAndAppliesShipping() {
        var items = List.of(new OrderItem("PROD-001", 2, 55.0));
