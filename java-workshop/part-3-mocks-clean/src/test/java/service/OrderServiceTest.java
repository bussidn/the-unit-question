...
class OrderServiceTest {
    ...
    // 1.5. Add a @Mock DiscountCodeService field and inject it via the OrderService constructor.
    ...
    // 2.3. Create a given helper for a valid discount code (e.g. givenDiscountCodeIsValid).
