...
class PricingServiceTest {
    ...
    @Test
    void p4_calculateTotal_withNoDiscount_appliesShippingWhenSubtotalBelowThreshold() {
    ...
    @Test
    void p4_calculateTotal_withNoDiscount_noShippingWhenSubtotalAtOrAboveThreshold() {
    ...
    @Test
    void p4_calculateTotal_withDiscount_thresholdAppliedOnDiscountedSubtotal() {
    ...
    @Test
    void p4_calculateTotal_withDiscount_noShippingWhenDiscountedSubtotalAboveThreshold() {
    ...
    @Test
    void p4_calculateTotal_withONCE50_halvesPriceAndAppliesShipping() {
        var items = List.of(new OrderItem("PROD-001", 2, 55.0));
