...
public class PricingServiceTest
{
    ...
    [Fact]
    public void P3_CalculateTotal_WithNoDiscount_AppliesShippingWhenSubtotalBelowThreshold()
    {
    ...
    [Fact]
    public void P3_CalculateTotal_WithNoDiscount_NoShippingWhenSubtotalAtOrAboveThreshold()
    {
    ...
    [Fact]
    public void P3_CalculateTotal_WithDiscount_ThresholdAppliedOnDiscountedSubtotal()
    {
    ...
    [Fact]
    public void P3_CalculateTotal_WithDiscount_NoShippingWhenDiscountedSubtotalAboveThreshold()
    {
    ...
    [Fact]
    public void P3_CalculateTotal_WithONCE50_HalvesPriceAndAppliesShipping()
    {
        var items = new List<OrderItem> { new("PROD-001", 2, 55.0) };
