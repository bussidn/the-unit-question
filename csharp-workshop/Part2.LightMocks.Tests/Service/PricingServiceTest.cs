...
public class PricingServiceTest
{
    ...
    [Fact]
    public void P2_CalculateTotal_WithNoDiscount_AppliesShippingWhenSubtotalBelowThreshold()
    {
    ...
    [Fact]
    public void P2_CalculateTotal_WithNoDiscount_NoShippingWhenSubtotalAtOrAboveThreshold()
    {
    ...
    [Fact]
    public void P2_CalculateTotal_WithDiscount_ThresholdAppliedOnDiscountedSubtotal()
    {
    ...
    [Fact]
    public void P2_CalculateTotal_WithDiscount_NoShippingWhenDiscountedSubtotalAboveThreshold()
    {
    ...
    [Fact]
    public void P2_CalculateTotal_WithONCE50_HalvesPriceAndAppliesShipping()
    {
        var items = new List<OrderItem> { new("PROD-001", 2, 55.0) };
